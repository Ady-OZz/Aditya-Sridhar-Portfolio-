        ...
        <AnimatePresence>
          <FadeUp key="title-greeting" duration={0.6}>
            <h1 className="text-6xl font-bold text-accent sm:text-7xl md:text-6xl lg:text-5xl xl:text-7xl">
              Hi, I&apos;m Aditya Sridhar
            </h1>
          </FadeUp>
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I&apos;m an Integrated M.Tech (CSE) student at Noida Institute of
              Engineering Technology (2022-2027), passionate about software
              development, problem solving, and building production-quality
              applications. I thrive at the intersection of backend engineering
          ...
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              showcasing my work across Java, Python, and full stack
              development.
            </p>
          </FadeUp>
          <FadeRight
